...
import genum.user.security.GenumAuthentication;
import genum.user.security.domain.TokenData;
import genum.user.security.exception.InvalidTokenException;
import genum.user.security.exception.TokenNotFoundException;
